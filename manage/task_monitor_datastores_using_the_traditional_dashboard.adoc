...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-resource-management.html["Documentação do VMware vSphere: Ative o controle de e/S de armazenamento"^]
