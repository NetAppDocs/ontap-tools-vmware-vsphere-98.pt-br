...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-availability.html["Documentação do VMware vSphere: Criando e usando clusters de HA do vSphere"^]
...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-availability/providing-fault-tolerance-for-virtual-machines/fault-tolerance-requirements-limits-and-licensing.html["Documentação do VMware vSphere: Requisitos, limites e licenciamento de tolerância a falhas"^]
